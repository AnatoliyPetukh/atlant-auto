...
const common = {
  ...
  "vehicle.sourceBadge.arval": entry("Авто с Arval", "Auto z Arval", "Vehicle from Arval"),
  "vehicle.sourceBadge.atc": entry("Авто с Automotive Trade Center", "Auto z Automotive Trade Center", "Vehicle from Automotive Trade Center"),
  "vehicle.sourceBadge.mobilede": entry("Авто с mobile.de", "Auto z mobile.de", "Vehicle from mobile.de"),
