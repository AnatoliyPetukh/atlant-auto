export const site = {
  ...
  email: "biuro@atlantauto.pl",
  address: "Wielkiego Dębu 6, 03-262 Warszawa",
  registeredAddress: "Zygmunta Vogla 28 lok. 02.42, 02-963 Warszawa",
  vehicleLotAddress: "Wielkiego Dębu 6, 03-262 Warszawa",
  officeMap: "https://www.google.com/maps/search/?api=1&query=Zygmunta+Vogla+28+lok.+02.42%2C+02-963+Warszawa",
  vehicleLotMap: "https://www.google.com/maps/search/?api=1&query=Wielkiego+D%C4%99bu+6%2C+03-262+Warszawa",
  nip: "9512563774",
  krs: "0001024667",
  regon: "524709974",
  krsSearch: "https://wyszukiwarka-krs.ms.gov.pl/"
};
...
const ru = [
  ...
  ["contact", "/kontakty/", "Контакты Atlant Auto в Варшаве", "Телефон, email и адрес Atlant Auto в Варшаве. Свяжитесь с нами для подбора автомобиля.", "Контакты Atlant Auto", "Расскажите, какой автомобиль ищете и какой бюджет планируете. Мы уточним задачу и предложим следующий практический шаг.", ["Телефон: +48 515 392 420", "Email: biuro@atlantauto.pl", "Wielkiego Dębu 6, Warszawa"]],
...
const pl = [
  ...
  ["about", "/pl/o-nas/", "O firmie i dane rejestrowe | Atlant Auto", "Oficjalne informacje o Atlant Capital Sp. z o.o., dane rejestrowe, kontakt oraz adres biura i placu samochodowego Atlant Auto w Warszawie.", "Atlant Auto — o firmie i oficjalne informacje", "Atlant Auto to marka motoryzacyjna polskiej spółki Atlant Capital Sp. z o.o. Na tej stronie publikujemy dane rejestrowe, dane kontaktowe oraz osobne adresy biura i placu samochodowego.", ["Polska spółka zarejestrowana w KRS", "Jawne dane kontaktowe i rejestrowe", "Biuro i plac samochodowy w Warszawie"]],
  ...
  ["contact", "/pl/kontakt/", "Kontakt z Atlant Auto w Warszawie", "Telefon, email i adres Atlant Auto w Warszawie. Skontaktuj się z nami w sprawie samochodu.", "Kontakt z Atlant Auto", "Napisz, jakiego samochodu szukasz i jaki planujesz budżet. Ustalimy wymagania i zaproponujemy kolejny krok.", ["Telefon: +48 515 392 420", "Email: biuro@atlantauto.pl", "Wielkiego Dębu 6, Warszawa"]],
...
const en = [
  ...
  ["about", "/en/about/", "Company information and registration details | Atlant Auto", "Official information about Atlant Capital Sp. z o.o., company registration details, contact information and the Warsaw office and vehicle lot addresses.", "Atlant Auto — company and official information", "Atlant Auto is the automotive brand of the Polish company Atlant Capital Sp. z o.o. This page provides our registration details, contact information and separate addresses for the office and vehicle lot.", ["Company registered in the Polish KRS", "Public contact and registration details", "Office and vehicle lot in Warsaw"]],
  ...
  ["contact", "/en/contact/", "Contact Atlant Auto in Warsaw", "Atlant Auto phone, email and Warsaw address. Contact us about sourcing a vehicle.", "Contact Atlant Auto", "Tell us what vehicle you need and your planned budget. We will clarify the brief and suggest the next practical step.", ["Phone: +48 515 392 420", "Email: biuro@atlantauto.pl", "Wielkiego Dębu 6, Warsaw"]],
