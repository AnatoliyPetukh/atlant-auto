...
export const locales = {
  ru: {
    ...
    home: "/",
    label: "Русский",
    nav: ["Автомобили", "Как мы работаем", "Калькулятор", "О компании", "Контакты"],
    routes: ["/avtomobili/", "/kak-my-rabotaem/", "/kalkulator/", "/o-kompanii/", "/kontakty/"],
    cta: "Обсудить подбор автомобиля",
    eyebrow: "Atlant Auto · Варшава",
    footer: "Подбор, проверка, выкуп и доставка автомобилей из Европы.",
    breadcrumb: "Главная"
  },
  pl: {
    lang: "pl",
...
const pl = [
  ...
  ["about", "/pl/o-nas/", "O Atlant Auto w Warszawie", "Atlant Auto to marka Atlant Capital Sp. z o.o. zajmująca się wyszukiwaniem i dostawą samochodów z Europy.", "O firmie Atlant Auto", "Działamy w Warszawie jako polska spółka Atlant Capital Sp. z o.o. Pomagamy ocenić oferty, dokumenty i pełny koszt zakupu.", ["Polska spółka", "Przejrzyste dane źródłowe", "Obsługa po polsku i rosyjsku"]],
...
export const pages = { ru, pl, en };

export const equivalents = Object.fromEntries(
  ru.map((page, index) => [page[0], { ru: page[1], pl: pl[index][1], en: en[index][1] }])
);
