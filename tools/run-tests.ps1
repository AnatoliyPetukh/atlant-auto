...
& $node --test atlant-auto-draft/js/customs-calculator.test.mjs atlant-auto-draft/js/catalog-data.test.mjs atlant-auto-draft/js/seo.test.mjs atlant-auto-draft/js/i18n.test.mjs
exit $LASTEXITCODE
